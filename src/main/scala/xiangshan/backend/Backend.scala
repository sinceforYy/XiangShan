...
class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parameters) extends LazyModuleImp(wrapper)
  ...
  dataPath.io.topDownInfo.l2TopMiss.l2Miss := RegNext(io.topDownInfo.l2TopMiss.l2Miss)
  dataPath.io.topDownInfo.l2TopMiss.l3Miss := RegNext(io.topDownInfo.l2TopMiss.l3Miss)
